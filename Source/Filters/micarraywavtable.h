...
#ifndef _CSAUDIOSSTCATPT_MICARRAYWAVTABLE_H_
#define _CSAUDIOSSTCATPT_MICARRAYWAVTABLE_H_
...
static
CSAUDIOSSTCATPT_PROPERTY_ITEM PropertiesMicArrayWaveFilter[] =
{
    {
        {
            &KSPROPSETID_General,
...
#endif // _CSAUDIOSSTCATPT_MICARRAYWAVTABLE_H_
